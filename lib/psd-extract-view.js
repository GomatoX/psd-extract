...
export default class PsdExtractView {
	...
	constructor(serializedState) {
		...
		this.loader = this.cE( 'loading-spinner-small' );
		this.importer.appendChild( this.loader );
		...
		this.importer.addEventListener( 'drop', function( event ) {
			...
			self.importer.classList.add( 'loading' );
	...
	constrols() {
		...
		zoomIn.classList.add( 'btn-primary' );
		
		var zoomOut = this.cE( 'zoom-out' );
		
		zoomOut.classList.add( 'btn' );
		zoomOut.classList.add( 'btn-primary' );
		...
		backBtn.addEventListener( 'click', function() {
			...
			self.importer.classList.remove( 'loading' );
		});
	...
	createObjects( Styles ) {
		...
		var handleObjClick = function() {
			...
			if ( typeof data['typeTool'] !== 'undefined' &&  typeof data['node'].text !== 'undefined' ) {
				...
				if ( typeof data['typeTool'].Leading !== 'undefined' ) {
